...
<% User user = (User) request.getSession().getAttribute("users") ;
	...
	<form action="ShowOrderServlet" method="post">
		<table class="table table-bordered" align="center" border="0"
			...
			<tr>
				<td class="aa" align="center" colspan="7"><p class="text-primary">我的购物车</p></td>
			</tr>
			<tr><td colspan="3"><a href="index.jsp" target="_parent">继续购物</a></td><td colspan="2"><a href="#">批量删除</a></td></tr>
			<tr>
    			<td>选项</td>
    			<td>书籍名</td>
    			<td>图书封面</td>
    ...
    <!--fmt:formatNumber 这个标签和c标签一样，也属于jstl标签库。表示按格式转换数字 。下面pattern="#.00"表示将数字保留2位小数进行转换 -->
    		...
    		<tr>
    			...
    			<td>${pprice}</td>
    			<td><a style="text-decoration:none;font-size: 18px;" href="AddBookNumServlet?bnum=${c.bnum}">+</a>
    				${c.bcount}
    				<a style="text-decoration:none;font-size: 18px;" href="DecreaseBookNumServlet?bnum=${c.bnum}">-</a>
    			</td>
    			<td>${c.bcount * pprice}</td>
    			<td><a href="DeleteCartServlet?bnum=${c.bnum}" target="_top">删除</a></td>
    		...
    		<tr>
    			...
    			<td colspan="7" align="right">小计 ：${formatSum}元</td>
    		</tr>
    		<tr>
    			<td colspan="7" align="right" ><a class="tocalcu" href="ShowOrderServlet">结算</a></td>
    		</tr>
