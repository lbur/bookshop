...
/**
 * Servlet implementation class DecreaseBookNumServlet
 */
public class DecreaseBookNumServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public DecreaseBookNumServlet() {
        super();
